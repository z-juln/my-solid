...
const { addNamed, addNamespace, isModule } = require('@babel/helper-module-imports');
...
module.exports = function createPlugin({
  ...
  console.log('input opts: ', forcedOptions, '\n');
  ...
  return declare((_, options) => {
    ...
    } = Object.assign(options, forcedOptions);
...
You can set \`throwIfNamespace: false\` to bypass this warning.`,
    ...
    // We want to use createElement, even in the case of
